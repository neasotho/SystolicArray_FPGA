...
proc create_hier_cell_mm_eval { parentCell nameHier } {
  ...
  source size.tcl
  set_property -dict [ list CONFIG.M "$M" CONFIG.N "$N" ] $mm_0
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk] [get_bd_pins mm_0/clk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk]
